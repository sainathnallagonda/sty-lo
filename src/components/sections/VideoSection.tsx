    ...
    <section className="py-20 bg-gradient-to-b from-purple-900/50 to-purple-800/30">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-gradient-to-r from-purple-800 to-pink-600 rounded-2xl overflow-hidden shadow-2xl">
            <div className="aspect-video bg-gradient-to-br from-purple-900 to-purple-700 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-purple-200">Experience the future of cross-border care</p>
              </div>
            </div>
