        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="bg-card border border-primary/20 rounded-2xl p-8 hover:border-primary/50 transition-all duration-300 group-hover:scale-105 shadow-lg">
                  <div className="w-20 h-20 mx-auto mb-6 rounded-full gradient-primary flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-all duration-300">
                    <IconComponent className={`w-8 h-8 text-white ${step.animation}`} />
                  </div>
                  
                  <div className="inline-block w-8 h-8 rounded-full gradient-primary text-white font-bold text-lg mb-4 flex items-center justify-center">
                    {step.number}
                  </div>
