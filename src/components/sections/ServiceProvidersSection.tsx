    ...
    <section className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center animate-on-scroll opacity-0">
          <div className="bg-glass border border-border rounded-2xl p-8 max-w-2xl mx-auto mb-6">
          ...
          <Button 
            ...
            className="bg-cta-gradient hover:scale-105 text-cta-foreground px-8 py-3 text-lg rounded-full shadow-elevated transform transition-all duration-300"
          >
